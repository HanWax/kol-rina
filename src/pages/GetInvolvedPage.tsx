        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-10 mt-8">
            ...
            <motion.div
              ...
              className="w-[220px] h-[220px] md:w-[240px] md:h-[240px] rounded-full bg-kr-navy shadow-[0_8px_40px_rgba(58,73,114,0.25)] flex flex-col items-center justify-center text-center"
            >
              <svg className="w-7 h-7 text-kr-gold mb-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="w-12 h-[1.5px] bg-kr-gold/40 my-2" />
              <p className="text-white/80 text-[11px] md:text-[12px] px-7 leading-relaxed font-body mb-3">
